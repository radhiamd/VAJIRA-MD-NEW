...
const BOTNAME = 'Meen-dereal';
const FOOTERNAME = '> ＶＡＪＩＲＡ -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '94701992015' ;  // 255718655518 
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=3QMjVC4D#Yo7BTCw8dSnbZ1s0UZ4TIYGAdnQuzY1-qtsw0TqWNfQ ' ,
